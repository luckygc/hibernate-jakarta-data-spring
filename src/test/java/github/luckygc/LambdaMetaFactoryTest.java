...
/**
 * LambdaMetaFactory JMH 基准测试 测试使用 LambdaMetaFactory 创建高性能方法调用器的性能 Benchmark Mode Cnt Score Error
 * Units LambdaMetaFactoryTest.benchmarkLambdaConstructorCall avgt 5 1.495 ± 0.082 ns/op
    ...
    public void setup() throws Throwable {
        ...
        MethodHandle constructorHandle =
                lookup.findConstructor(
                        TestClass.class, MethodType.methodType(void.class, String.class));

        CallSite constructorCallSite =
        ...
        lambdaConstructor =
                (Function<String, TestClass>) constructorCallSite.getTarget().invokeExact();
    }
